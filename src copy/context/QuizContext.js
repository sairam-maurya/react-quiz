...
function QuizProvider({children}){
    ...
    return (
        <QuizContext.Provider value={{questions,status,index,answer,points,highscore,secondsRemaning,numQuestions,maxPossiblePoints,dispatch}}>{children}</QuizContext.Provider>
    )
